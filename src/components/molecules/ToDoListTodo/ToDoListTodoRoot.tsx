...
export function ToDoListTodoRoot({children}: ToDoListTodoRootProps) {
  return (
    <Checkbox color="primary" radius="full" className={`${styles.checkbox} group`} classNames={{
      ...
      label: "w-full",
    }}><div className="flex items-center justify-between pl-[0.75rem]">{children}</div></Checkbox>
  )
} 